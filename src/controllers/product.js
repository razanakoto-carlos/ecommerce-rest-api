...
// 1. Obtenir le chemin du fichier actuel
const __filename = fileURLToPath(import.meta.url);

// 2. Obtenir le dossier du fichier actuel
...
const getProduct = async (req, res) => {
    ...
    const product = await Product.findById(productId).populate("seller", "name email").select("-category -__v")
